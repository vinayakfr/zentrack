      ...
      <main className="flex-1 p-8 pt-6 pr-4 relative z-10 flex flex-col h-full overflow-hidden">
        <header className="flex justify-between items-center mb-10 pr-6 flex-shrink-0">
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1">Manage your account and subscription preferences.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-6xl w-full flex-1 overflow-hidden">
          ...
          <div className="lg:col-span-3 overflow-y-auto space-y-12 pb-16 h-full pr-6">
              ...
              <Card className="p-7 bg-[#1C1C1F] border-none space-y-8 rounded-2xl">
                <div className="flex items-center space-x-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-orange-500 to-purple-600 flex items-center justify-center text-3xl font-bold shadow-lg shadow-orange-500/10">
                    {userEmail ? userEmail[0].toUpperCase() : "Z"}
                  </div>
                  <div className="space-y-3">
                    <div className="text-sm font-medium">Account</div>
                    <div className="text-sm text-zinc-400">{userEmail || "Not logged in"}</div>
                    <div className="flex gap-3">
                      <Button className="bg-zinc-800 hover:bg-zinc-700 text-xs border-none h-8 px-4 rounded-lg">Upload Avatar</Button>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Email" value={userEmail || ""} className="bg-[#24242A] border-zinc-800/40 focus:border-orange-500/50" readOnly />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-zinc-400">Display Name</label>
                    <Input placeholder="Your Name" className="bg-[#24242A] border-zinc-800/40 focus:border-orange-500/50" />
                  </div>
                </div>
              </Card>
            </section>
                ...
                <div className="p-7 relative z-10">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                      ...
                      <h3 className="text-2xl font-medium tracking-tight">ZenTrack Free</h3>
                      <p className="text-sm text-zinc-400 mt-1">You&apos;re using the free tier with unlimited subscription tracking.</p>
                    </div>
                    <div className="text-left md:text-right">
                      <div className="text-3xl font-semibold tracking-tight">$0.00 <span className="text-sm font-normal text-zinc-500">/mo</span></div>
